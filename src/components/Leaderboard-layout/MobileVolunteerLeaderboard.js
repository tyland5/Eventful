    ...
    const MobileBadgeNav = () => {
        return(
            <div className='mobileBadgeNav'>
                ...
                <Link to="/mobile-volunteer-leaderboard" className='routing-link'><a className="active" href = '#volunteer' style={{color: 'white'}}>Volunteer</a></Link>
        ...
        return (
            <div className='leader'>
                ...
                {createLeaderboard.map((value, idx) => {
                    return (
                        <LeaderboardMobile username={createLeaderboard[idx].user_id} rank={idx+1} rowColor={RowColor(idx)} badge={BadgeType(createLeaderboard[idx].volunteer)} eventsAttended={createLeaderboard[idx].volunteer}/>
                    )
                })}
            </div>
        )
