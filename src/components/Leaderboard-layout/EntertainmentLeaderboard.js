    ...
    const SideNav = () => {
        return(
            <ul className='sideNav'>
                ...
                <Link to="/entertainment-leaderboard" className="routing-link-category"><li><a class='active' href = '#entertainment'><p className='category-text'>Entertainment</p></a></li></Link>
