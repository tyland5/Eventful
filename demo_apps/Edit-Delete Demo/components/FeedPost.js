...
const FeedPost = ({pfp, posterName, thumbnail}) => {
  return (
    <>
        <div className="post-feedview">
                    
            <div className="lpost-feedview">
                <img className ="poster-pfp-feedview" src={pfp} />
            ...
            <div className = "rpost-feedview">
                ...
                <p className="title-feedview">Firework showing at Fairgrounds!</p>
                
                <div className="post-footer-feedview">
                    <p className = "num-bookmarked-feedview">280 people are following this event</p>
                    <p className="tags-feedview">Recreation</p>
                </div>
            </div>
